...
use App\Http\Controllers\webSiteControllers\pages\AboutController;
use App\Http\Controllers\webSiteControllers\pages\RoomCategoryController;
use App\Http\Controllers\webSiteControllers\pages\FacilitiyController;
use App\Http\Controllers\webSiteControllers\pages\ContactController;
use App\Http\Controllers\webSiteControllers\pages\RoomOverviewController;
use App\Http\Controllers\webSiteControllers\pages\ReservationController;
...
Route::resource('/', 'webSiteControllers\HomeController');
Route::resource('/about-us', 'webSiteControllers\pages\AboutController');
Route::resource('/room-categories', 'webSiteControllers\pages\RoomCategoryController');
Route::resource('/facilities', 'webSiteControllers\pages\FacilitiyController');
Route::resource('/contact', 'webSiteControllers\pages\ContactController');

Route::get('/room-overview/rooms-list', 'webSiteControllers\pages\RoomOverviewController@roomsList');
Route::resource('/room-overview', 'webSiteControllers\pages\RoomOverviewController');


Route::get('/reservation-checkout', 'webSiteControllers\pages\ReservationController@checkout');
Route::resource('/reservation', 'webSiteControllers\pages\ReservationController');
