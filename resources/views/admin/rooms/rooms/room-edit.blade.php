        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formEditRoom" id="formEditRoom">
                        @csrf
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="hotel" name="hotel" required>
                                    <option value="{{ $singleRecord->roomType->hotel->id}}"> {{ $singleRecord->roomType->hotel->name}} </option>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="roomType" name="roomType" id="roomType" required>
                                    <option value="{{ $singleRecord->roomType->id}}"> {{ $singleRecord->roomType->room_type_name}} </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Days</label>
                            <input type="text" class="form-control" required placeholder="Please enter days here" name="days" value="{{ $singleRecord->no_of_days}}"/>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Price</label>
                            <input type="text" class="form-control" required placeholder="Please enter room price according to days here" name="price" value="{{ $singleRecord->price}}"/>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control"  placeholder="Please enter state name here" name="discount" value="{{ $singleRecord->discount}}" />
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>G.S.T</label>
                            <input type="text" class="form-control" required placeholder="Please enter hotel email here" name="gst" value="{{ $singleRecord->g_s_t}}"/>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control-tags-input" data-role="tagsinput"  name="amenities" id="amenities" value="{{ $singleRecord->amenities}}"/>
