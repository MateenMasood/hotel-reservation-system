                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Days</label>
                            <input type="text" class="form-control" required placeholder="Please enter days here" name="days"/>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Price</label>
                            <input type="text" class="form-control" required placeholder="Please enter room price according to days here" name="price" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control"  placeholder="Please enter state name here" name="discount" />
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>G.S.T</label>
                            <input type="text" class="form-control" required placeholder="Please enter hotel email here" name="gst" />
                        </div>
