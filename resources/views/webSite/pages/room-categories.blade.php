...
@section('content')
       ...
       <section class="page">
        ...
        <div class="page-header" style="background-image:url({{ ('assets/webSiteAssets/images/header-1.jpg') }})">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="item">
                            <article>
                                <div class="image">
                                    <img src="{{ ('assets/webSiteAssets/images/apartment-1.jpg') }}" alt="" />
                                </div>
                                <div class="details">
                                    <div class="text">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="item">
                            <article>
                                <div class="image">
                                    <img src="{{ ('assets/webSiteAssets/images/apartment-2.jpg') }}" alt="" />
                                </div>
                                <div class="details">
                                    <div class="text">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="item">
                            <article>
                                <div class="image">
                                    <img src="{{ ('assets/webSiteAssets/images/room-1.jpg') }}" alt="" />
                                </div>
                                <div class="details">
                                    <div class="text">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="item">
                            <article>
                                <div class="image">
                                    <img src="{{ ('assets/webSiteAssets/images/room-2.jpg') }}" alt="" />
                                </div>
                                <div class="details">
                                    <div class="text">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="item">
                            <article>
                                <div class="image">
                                    <img src="{{ ('assets/webSiteAssets/images/room-3.jpg') }}" alt="" />
                                </div>
                                <div class="details">
                                    <div class="text">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-8">
                    <figure>
                        <figcaption style="background-image:url({{ ('assets/webSiteAssets/images/activity-1.jpg') }})">
                            <img src="{{ ('assets/webSiteAssets/images/activity-1.jpg') }}" alt="" />
                        </figcaption>
                ...
                <div class="col-xs-6 col-md-4">
                    <figure>
                        <figcaption style="background-image:url({{ ('assets/webSiteAssets/images/activity-2.jpg') }})">
                            <img src="{{ ('assets/webSiteAssets/images/activity-2.jpg') }}" alt="" />
                        </figcaption>
                ...
                <div class="col-xs-6 col-md-4">
                    <figure>
                        <figcaption style="background-image:url({{ ('assets/webSiteAssets/images/activity-3.jpg') }})">
                ...
                <div class="col-xs-6 col-md-4">
                    <figure>
                        <figcaption style="background-image:url({{ ('assets/webSiteAssets/images/activity-4.jpg') }})">
                ...
                <div class="col-xs-6 col-md-4">
                    <figure>
                        <figcaption style="background-image:url({{ ('assets/webSiteAssets/images/activity-5.jpg') }})">
