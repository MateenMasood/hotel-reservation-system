...
{{--
                    ...
                    <div class="clearfix">
                        ...
                        <div class="cart-block cart-block-item clearfix">
                            <div class="image">
                                <a href="{{ url('/room-overview') }}"><img src="{{ asset ('assets/webSiteAssets/images/room-4.jpg') }}" alt="" /></a>
                            </div>
                            <div class="title">
                                <div class="h2"><a href="{{ url('/room-overview') }}">Luxury appartment</a></div>
                                <div>
                    ...
                    <div class="clearfix">
                        <div class="cart-block cart-block-footer cart-block-footer-price clearfix">
                            <div>
                                <a href="{{ url('/room-overview/rooms-list')}}" class="btn btn-clean-dark">Back</a>
                            </div>
                            <div>
                                <a href="{{ url('/reservation-checkout')}}" class="btn btn-main">Checkout <span class="icon icon-chevron-right"></span></a>
                            </div>
                        </div>
                    </div>
