    ...
    <div class="container">
        ...
        <nav class="navigation-top clearfix">
            ...
            <div class="navigation-top-left">
                <a class="box" href="https://www.facebook.com/chaletpakistan/">
                    <i class="fa fa-facebook"></i>
                </a>
                <a class="box" href="https://twitter.com/chaletmultan">
        ...
        <nav class="navigation-main clearfix">
            ...
            <div class="logo animated fadeIn">
                <a href="{{ asset('/') }}">
                    <img class="logo-desktop" src="{{ asset('assets/webSiteAssets/images/logo.png') }}" alt="Alternate Text" />
                    <img class="logo-mobile" src="{{ asset('assets/webSiteAssets/images/logo-mobile.png') }}" alt="Alternate Text" />
                </a>
            </div>
            ...
            <div class="navigation-block clearfix">
                ...
                <ul class="navigation-left">
                    <li>
                        <a href="{{ asset('/') }}">Home <span class="open-dropdown"></span></a>
                        {{-- <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('/room-categories') }}">Rooms category</a></li>
