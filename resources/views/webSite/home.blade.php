...
@section('css')
<link rel="stylesheet" href="{{ asset ('assets/webSiteAssets/customCss/home.css') }}">
...
@section('content')
       ...
       <section class="frontpage-slider">
        <div class="owl-slider owl-slider-header owl-slider-fullscreen">
            ...
            <div class="item" style="background-image:url({{asset('assets/webSiteAssets/images/slide-3.jpg') }})">
                <div class="box text-center">
                    <div class="container">
                        ...
                        <div class="desc animated" data-animation="fadeInUp">
                            Lavish social and business events <br>
            ...
            <div class="item" style="background-image:url(assets/webSiteAssets/images/slide-1.jpg)">
                <div class="box text-center">
                    <div class="container">
                        <h2 class="title animated h1" data-animation="fadeInDown">
                            The privacy and <br />
            ...
            <div class="item" style="background-image:url(assets/webSiteAssets/images/slide-2.jpg)">
                <div class="box text-center">
                    <div class="container">
                        <div class="rating animated" data-animation="fadeInDown">
                            <i class="fa fa-star"></i>
            ...
            <div class="container">
                ...
                <!--=== Destination ===-->
                    <div class="col-xs-4 col-sm-2">
                        <div class="guests" id="destination" data-text="Destination">
                            {{-- <input class="destionation" readonly="readonly" value="Islambad" style="display: none;"  /> --}}
                                <div id="selectedHotel" class="qty-result-text date-value" style="font-size: 35px;"> {{ $listOfHotels[0]['city']}} </div>
                                {{-- ************** hotel id *********** --}}
                                <input type="hidden" id="hotelId" value="{{ $listOfHotels[0]['id'] }} ">
                    ...
                    <div class="col-xs-4 col-sm-2">
                        <div class="date" id="dateArrival" data-text="Check In">
                            ...
                            <div class="date-value" id="arrivalDate"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-4 col-sm-2">
                        <div class="date" id="dateDeparture" data-text="Check Out">
                            <input class="datepicker" readonly="readonly" />
                            <div class="date-value" id="departureDate"></div>
                        </div>
                    </div>
                        ...
                        <div class="guests" data-text="Guests">
                            ...
                            <ul class="guest-list">
                                ...
                                <li class="clearfix">
                                    ...
                                    <div>
                                        <input class="qty-amount" value="2" type="text" id="ticket-adult" data-value="1" readonly="readonly" />
                                    </div>
                    ...
                    <div class="col-xs-8 col-sm-4">
                        <button id="bookNow" class="btn btn-clean">
                            Book now
        ...
        <div class="container">
            ...
            <div class="owl-rooms owl-theme">
                ...
                <div class="item">
                    <article>
                        <div class="image">
                            <img src="{{ asset('assets/webSiteAssets/images/room-1.jpg') }}" alt="" />
                        </div>
                        <div class="details">
                            <div class="text">
                ...
                <div class="item">
                    <article>
                        <div class="image">
                            <img src="{{ asset('assets/webSiteAssets/images/room-2.jpg') }}" alt="" />
                        </div>
                        <div class="details">
                            <div class="text">
                ...
                <div class="item">
                    <article>
                        <div class="image">
                            <img src="{{ asset('assets/webSiteAssets/images/room-3.jpg') }}" alt="" />
                        </div>
                        <div class="details">
                            <div class="text">
                ...
                <div class="item">
                    <article>
                        <div class="image">
                            <img src="{{ asset('assets/webSiteAssets/images/room-4.jpg') }}" alt="" />
                        </div>
                        <div class="details">
                            <div class="text">
    ...
    <section class="stretcher-wrapper">
        ...
        <ul class="stretcher">
            ...
            <li class="stretcher-item more">
                ...
                <a href="{{ url('/facilities') }}">Anchor link</a>
            </li>
    ...
    <section class="image-blocks image-blocks-header">
        ...
        <div class="section-header" style="background-image:url(assets/webSiteAssets/images/header-1.jpg)">
            <div class="container">
        ...
        <div class="container">
            ...
            <div class="blocks blocks-left">
                ...
                <div class="image" style="background-image:url({{ asset('assets/webSiteAssets/images/apartment-1.jpg') }})">
                    <img src="{{ asset('assets/webSiteAssets/images/apartment-1.jpg') }}" alt="" />
                </div>
            </div>
            ...
            <div class="blocks blocks-right">
                ...
                <div class="image" style="background-image:url({{ asset('assets/webSiteAssets/images/apartment-2.jpg') }})">
                    <img src="{{ asset('assets/webSiteAssets/images/apartment-2.jpg') }}" alt="" />
                </div>
            </div>
    ...
    <section class="quotes quotes-slider" style="background-image:url(assets/webSiteAssets/images/header-1.jpg)">
        <div class="container">
...
<script src="{{ asset ('assets/webSiteAssets/customJs/home.js') }}"></script>
